...
<body>
<div id="hello">
<h1 class="hello">Hello world, my name is<a href="#email-bckg" id="bannik" onclick="show()"> *Bannik</a>, also known as Nik Christodoulakis.  I'm a web designer and developer from Athens.</h1>
</div>
...
<div class="available">available for new projects</div>
